    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center">
          <a
            href="https://www.yiyeguizhen.com/health"
            target="_blank"
            rel="noopener noreferrer"
            className="relative overflow-hidden rounded-3xl flex flex-col justify-between transition-transform hover:scale-[1.02]"
            style={{
              width: 300,
              minHeight: 420,
              background: `linear-gradient(160deg, #120300 0%, #1e0500 40%, #0A0200 100%)`,
              border: `1px solid ${BY_RED}35`,
              boxShadow: `0 0 50px rgba(204,34,0,0.15)`,
              textDecoration: "none",
            }}
          >
            {/* 背景光晕 */}
            <div
              ...
              style={{
                background: `radial-gradient(ellipse 70% 50% at 50% 30%, rgba(204,34,0,0.18) 0%, transparent 70%)`,
              }}
            />
            {/* 粒子纹理 */}
            <img
              ...
              style={{ opacity: 0.06, mixBlendMode: "screen" } as React.CSSProperties}
            />

            {/* 顶部：且酌logo旋转 */}
            <div className="relative z-10 pt-8 px-8 flex justify-end">
              <img
            ...
            {/* 中间大字 */}
            <div className="relative z-10 px-8 flex-1 flex flex-col justify-center gap-4">
              <p
                className="text-6xl font-black leading-none"
                style={{
                  fontFamily: "'Noto Serif SC', serif",
                  color: BY_CREAM,
                  textShadow: `0 0 40px rgba(204,34,0,0.4)`,
                }}
              >
                撑
                <br />
              ...
              <div className="space-y-1">
                <p
                  ...
                  style={{ fontFamily: "'Noto Serif SC', serif", color: BY_RED }}
                >
                  且酌一杯
                </p>
                <p className="text-xs tracking-wider" style={{ color: `${BY_CREAM}60` }}>
                  东方植养 · 席间护卫
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10 px-8 pb-8">
              <div
                className="flex items-center justify-between px-4 py-3 rounded-xl text-xs font-medium"
                style={{
                  background: `${BY_RED}20`,
                  border: `1px solid ${BY_RED}40`,
                  color: BY_CREAM,
                }}
              >
                <span>进入且酌首页</span>
